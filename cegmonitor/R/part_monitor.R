#' The partition monitor examines the probability p(U_t | x^{t-1}), 
#' i.e. observing the partitoning into stagings for the elements in a cut
#'
#'
#' @param rho double of the probability of situations composing stage changing
#' @param epsilon integer of maximum allowable distances on the hasse diagram
#' @param df_cut data frame
#' @param which.cut integer of the cut that we want to check the staging of
#' @param stage.key list of data frames generated by tostagekey()
#' @param n.monitor integer of number of records to consider from the data frame
#' @param tau double of the rate of forgetting
#' @param k is some parameter between 0 and 1 for downweighting past data
