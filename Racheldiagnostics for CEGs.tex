...
% Conditional stage monitors calculate $-\log (p_m(u_k | \mathcal{E}^m \setminus \mathcal{E}_m(u_k)))$, that is the conditional probability of stage $u_k$ given the evidence for $m$ cases excluding the evidence for $u_k$ in case $m$. These probabilities can be computed from the belief propagation algorithm given in ]cite{CEGBOOK}. The \texttt{pass.message} function relies on the pseudocode from \cite{Collazo}.
% 
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{cegA.png}
  \caption{CEG A}
  \label{fig:CEGa}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=\linewidth]{CEGb.png}
  \caption{CEG B}
  \label{fig:CEGb}
\end{subfigure}
...
& $P(X_l = (h,m,l) | u_5) = (0.47, 0.31, 0.22) $  \\ %%CHECK THIS OUTTTT
\hline
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=4in]{stageCEG.png} 
   \caption{Stage monitor shown for $\rho = 0.25$}
   \label{fig:stageceg}
\end{figure}
...
%\begin{subfigure}{.5\textwidth}
%  \centering
%  \includegraphics[width=\linewidth]{stageCEGa.png}
%  \caption{CEG A}
%  \label{fig:CEGa}
%\end{subfigure}%
%\begin{subfigure}{.5\textwidth}
%  \centering
%  \includegraphics[width=\linewidth]{stageCEGb.png}
%  \caption{CEG B}
%  \label{fig:CEGb}
%\end{subfigure}
%\caption{Two CEGs for the CHDS dataset}
